        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <c:url var="editar_produto_url" value="/produto/editarProduto" />
                    <form:form action="${editar_produto_url}" method="post" modelAttribute="produto">

                        <form:input type="hidden" path="codProduto" value="${produto.codProduto}" />

                        <div class="form-group">
                            <form:label path="nome">Nome:</form:label>
                            <form:input type="text" path="nome" value="${produto.nome}" />
                        </div>
                        <div class="form-group">
                            <form:label path="descricao">Descrição:</form:label>
                            <form:input type="text" path="descricao" value="${produto.descricao}" />

                        </div>
                        <div class="form-group">
                            <form:label path="preco">Preço:</form:label>
                            <form:input type="text" path="preco" value="${produto.preco}" />
                        </div>
